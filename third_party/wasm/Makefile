...
help:
	@echo 'Management commands for DSiSc/wasm:'
	@echo
	@echo 'Usage:'
...
build:
	...
	@echo "GOPATH=${GOPATH}"
	go build -v -ldflags "-X github.com/DSiSc/wasm/version.GitCommit=${GIT_COMMIT}${GIT_DIRTY} -X github.com/DSiSc/wasm/version.BuildDate=${BUILD_DATE}" ./...
